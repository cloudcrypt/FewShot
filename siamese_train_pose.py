...
from posedataset_loader import PoseDatasetTest, PoseDatasetTrain
...
if __name__ == '__main__':
    ...
    Flags = gflags.FLAGS
    gflags.DEFINE_string("train_path", "D:/Downloads/bpM6x25_C/bpM6x25_C/", "training folder")
    gflags.DEFINE_string("test_path", "D:/Downloads/bpM6x25_C/bpM6x25_C/", 'path of testing folder')
    ...
    trainSet = PoseDatasetTrain(Flags.train_path, transform=data_transforms)
    testSet = PoseDatasetTest(Flags.test_path, transform=transforms.ToTensor(), times = Flags.times, way = Flags.way)
